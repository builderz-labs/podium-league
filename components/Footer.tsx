...
const Footer = ({ toggleDisclaimer, toggleUnofficial }: FooterProps) => {
  return (
    <footer className="container mx-auto footer relative z-10 flex w-[100%] items-center justify-between bg-white px-0 py-1 text-center  text-black lg:absolute  lg:bottom-0">
      <div className=" block md:flex w-full items-center justify-between">
        <div className="text-[8px] text-start  w-full md:w-[387px] font-[400] text-[#55CBCD]">
        ...
        <div className="text-[8px] text-center w-full md:w-[400px] font-[400] text-[#55CBCD] ">
